...
class Command {
    ...
    static setArgumentTransformer(name, func, includeCmd) {
        if (func) {
    ...
    transformReply(result) {
        ...
        const transformer = (_a = Command._transformer.reply[this.preTransformedName]) !== null && _a !== void 0 ? _a : Command._transformer.reply[this.name];
        if (transformer) {
