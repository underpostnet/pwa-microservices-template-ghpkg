...
declare type ArgumentTransformerFunction = (args: any[]) => any[];
...
export default class Command implements Respondable {
    ...
    static setArgumentTransformer(name: string, func?: ArgumentTransformerFunction, includeCmd?: boolean): void;
