...
const event_handler_1 = require("./redis/event_handler");
...
class Redis extends Commander_1.default {
    ...
    connect(callback) {
        const promise = new Promise((resolve, reject) => {
            ...
            (0, event_handler_1.validateFamilyFallbackOptions)(this);
            (0, event_handler_1.updateTriedFamilies)(this, this.options.family);
            const { options } = this;
            this.condition = {
                select: options.db,
