...
exports.updateTriedFamilies = exports.getNextFamilyToTry = exports.validateFamilyFallbackOptions = exports.handleFamilyFallbackOptions = exports.readyHandler = exports.errorHandler = exports.closeHandler = exports.connectHandler = void 0;
 ...
 */
function handleFamilyFallbackOptions(self) {
    validateFamilyFallbackOptions(self);
    const fallback = self.options.familyFallback;
    if (!fallback.enabled) {
        return;
    }
    const currentFamily = self.options.family;
...
exports.handleFamilyFallbackOptions = handleFamilyFallbackOptions;
/**
 * Validates and normalizes the family fallback options
 * @param self - The Redis client instance
 * @throws {Error} If validation fails
 */
function validateFamilyFallbackOptions(self) {
    var _a;
    const { familyFallback: options } = self.options;
    const initialFamily = (_a = options === null || options === void 0 ? void 0 : options._initialFamily) !== null && _a !== void 0 ? _a : self.options.family;
    const fallback = {
        enabled: true,
        alternate: false,
...
exports.validateFamilyFallbackOptions = validateFamilyFallbackOptions;
/**
 ...
 */
function getNextFamilyToTry(fallback, currentFamily) {
    if (fallback.alternate) {
        return currentFamily === 4 ? 6 : 4;
    }
    if (!fallback._triedFamilyFour)
        return 4;
    if (!fallback._triedFamilySix)
        return 6;
    return fallback._initialFamily;
}
exports.getNextFamilyToTry = getNextFamilyToTry;
/**
 * Updates the tried families tracking in the fallback options
 * @param self - The Redis client instance
 * @param family - The family that was just tried (4 or 6)
 */
function updateTriedFamilies(self, family) {
...
exports.updateTriedFamilies = updateTriedFamilies;
