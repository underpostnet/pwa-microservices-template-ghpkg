...
interface RedisCommander<Context extends ClientContext = {
    ...
    zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, withscores: "WITHSCORES", callback?: Callback<string[]>): Result<string[], Context>;
    zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, withscores: "WITHSCORES", callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
    ...
    zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, limitToken: "LIMIT", offset: number | string, count: number | string, withscores: "WITHSCORES", callback?: Callback<string[]>): Result<string[], Context>;
    zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, limitToken: "LIMIT", offset: number | string, count: number | string, withscores: "WITHSCORES", callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
    ...
    zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, rev: "REV", withscores: "WITHSCORES", callback?: Callback<string[]>): Result<string[], Context>;
    zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, rev: "REV", withscores: "WITHSCORES", callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
    ...
    zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, rev: "REV", limitToken: "LIMIT", offset: number | string, count: number | string, withscores: "WITHSCORES", callback?: Callback<string[]>): Result<string[], Context>;
    zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, rev: "REV", limitToken: "LIMIT", offset: number | string, count: number | string, withscores: "WITHSCORES", callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
    ...
    zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: "BYSCORE", withscores: "WITHSCORES", callback?: Callback<string[]>): Result<string[], Context>;
    zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: "BYSCORE", withscores: "WITHSCORES", callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
    ...
    zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: "BYSCORE", limitToken: "LIMIT", offset: number | string, count: number | string, withscores: "WITHSCORES", callback?: Callback<string[]>): Result<string[], Context>;
    zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: "BYSCORE", limitToken: "LIMIT", offset: number | string, count: number | string, withscores: "WITHSCORES", callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
    ...
    zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: "BYSCORE", rev: "REV", withscores: "WITHSCORES", callback?: Callback<string[]>): Result<string[], Context>;
    zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: "BYSCORE", rev: "REV", withscores: "WITHSCORES", callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
    ...
    zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: "BYSCORE", rev: "REV", limitToken: "LIMIT", offset: number | string, count: number | string, withscores: "WITHSCORES", callback?: Callback<string[]>): Result<string[], Context>;
    zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, byscore: "BYSCORE", rev: "REV", limitToken: "LIMIT", offset: number | string, count: number | string, withscores: "WITHSCORES", callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
    ...
    zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: "BYLEX", withscores: "WITHSCORES", callback?: Callback<string[]>): Result<string[], Context>;
    zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: "BYLEX", withscores: "WITHSCORES", callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
    ...
    zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: "BYLEX", limitToken: "LIMIT", offset: number | string, count: number | string, withscores: "WITHSCORES", callback?: Callback<string[]>): Result<string[], Context>;
    zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: "BYLEX", limitToken: "LIMIT", offset: number | string, count: number | string, withscores: "WITHSCORES", callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
    ...
    zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: "BYLEX", rev: "REV", withscores: "WITHSCORES", callback?: Callback<string[]>): Result<string[], Context>;
    zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: "BYLEX", rev: "REV", withscores: "WITHSCORES", callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
    ...
    zrange(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: "BYLEX", rev: "REV", limitToken: "LIMIT", offset: number | string, count: number | string, withscores: "WITHSCORES", callback?: Callback<string[]>): Result<string[], Context>;
    zrangeBuffer(key: RedisKey, start: string | Buffer | number, stop: string | Buffer | number, bylex: "BYLEX", rev: "REV", limitToken: "LIMIT", offset: number | string, count: number | string, withscores: "WITHSCORES", callback?: Callback<Buffer[]>): Result<Buffer[], Context>;
    /**
