...
export declare class GridBodyScrollFeature extends BeanStub {
    ...
    setHorizontalScrollPosition(hScrollPosition: number, _fromAlignedGridsService?: boolean): void;
    private getMaxHorizontalScrollLeft;
    private clampHorizontalScrollPosition;
