...
export declare class FilterMenuFactory extends BeanStub implements NamedBean, IMenuFactory {
    ...
    showMenuAfterButtonClick(column: AgColumn | AgProvidedColumnGroup | undefined, eventSource: HTMLElement, containerType: ContainerType, onClosedCallback?: (event?: Event) => void, options?: ShowMenuAfterButtonClickOptions): boolean;
    private showPopup;
