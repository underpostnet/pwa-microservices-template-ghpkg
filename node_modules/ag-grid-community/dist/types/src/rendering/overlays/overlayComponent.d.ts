...
export type IOverlayParams<TData = any, TContext = any> = ILoadingOverlayParams<TData, TContext> | IExportingOverlayParams<TData, TContext> | INoRowsOverlayParams<TData, TContext> | INoMatchingRowsOverlayParams<TData, TContext> | IFileInputOverlayParams<TData, TContext>;
