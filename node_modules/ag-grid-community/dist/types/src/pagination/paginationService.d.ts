...
export declare class PaginationService extends BeanStub implements NamedBean {
    ...
    setPageSize(size: number | undefined, source: 'autoCalculated' | 'pageSizeSelector' | 'initialState' | 'panel' | 'gridOptions'): void;
    private applyExplicitPageSize;
    private setZeroRows;
