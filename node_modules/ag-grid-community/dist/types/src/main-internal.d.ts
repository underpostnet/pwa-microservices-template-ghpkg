...
export type { IPdfCreator, PdfCell, PdfCellData, PdfCellHyperlinkCallbackParams, PdfCellStyle, PdfCellStyleCallbackParams, PdfColors, PdfColumnWidth, PdfColumnWidthCallback, PdfCustomContent, PdfDocumentTitleStyle, PdfExportParams, PdfFontFamily, PdfFontWeight, PdfGroupHeaderStyleCallbackParams, PdfHeaderStyleCallbackParams, PdfMargin, PdfPageOrientation, PdfPageSetup, PdfPageSize, PdfRowStyleCallbackParams, PdfStyleCallbackParams, PdfStyleCallbackType, PdfTextAlignment, PdfTextOverflow, } from './interfaces/iPdfCreator';
