...
export interface IMenuFactory {
    showMenuAfterButtonClick(column: MenuColumn, eventSource: HTMLElement, containerType: ContainerType, onClosedCallback?: (event?: Event) => void, options?: ShowMenuAfterButtonClickOptions): boolean;
