...
export declare class MenuService extends BeanStub implements NamedBean {
    ...
    private activeButtonMenu?;
    postConstruct(): void;
    destroy(): void;
    showColumnMenu(params: ShowColumnMenuParams): void;
    showFilterMenu(params: ShowFilterMenuParams): void;
    toggleColumnMenu(params: ToggleColumnMenuParams): PopupToggleResult;
    toggleFilterMenu(params: ToggleFilterMenuParams): PopupToggleResult;
