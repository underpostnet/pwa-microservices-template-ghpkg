...
type ReleaseType = TruncationType | 'next' | 'conventional' | 'conventional-prerelease';
//#endregion
 ...
 */
interface NormalizedPullRequestOptions {
  branch: string;
  base?: string;
  title?: string;
...
type VersionNumber = `${number}` | `${number}${string}`;
type VersionBumpRelease = ReleaseType | 'prompt' | VersionNumber | `v${VersionNumber}`;
/**
 ...
 */
interface PullRequestBodyTokens {
  version: string;
  oldVersion: string;
  tag: string;
  releaseType: string;
 ...
 * - "prompt" to prompt the user for the version number
 */
declare function versionBump(release: VersionBumpRelease): Promise<VersionBumpResults>;
/**
 ...
 */
declare function versionBumpInfo(arg?: VersionBumpOptions | VersionBumpRelease): Promise<Operation>;
//#endregion
...
//#endregion
export { InterfaceOptions, NpmScript, ProgressEvent, PullRequestBodyTokens, PullRequestOptions, type ReleaseType, VersionBumpOptions, VersionBumpProgress, VersionBumpRelease, VersionBumpResults, VersionNumber, bumpConfigDefaults, versionBump as default, versionBump, defineConfig, loadBumpConfig, versionBumpInfo };