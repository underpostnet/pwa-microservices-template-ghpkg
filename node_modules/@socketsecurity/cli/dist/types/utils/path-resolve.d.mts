...
export declare function getPackageFilesForScan(inputPaths: string[], supportedFiles: SocketSdkSuccessResult<'getSupportedFiles'>['data'], options?: PackageFilesForScanOptions | undefined): Promise<string[]>;
