...
export declare const IGNORED_DIRS: readonly [".git", ".log", ".nyc_output", ".sass-cache", ".yarn", "bower_components", "coverage", "node_modules", "flow-typed", ".venv"];
...
export declare function filterBySupportedScanFiles(filepaths: string[] | readonly string[], supportedFiles: SocketSdkSuccessResult<'getSupportedFiles'>['data']): string[];
export declare function createSupportedFilesFilter(supportedFiles: SocketSdkSuccessResult<'getSupportedFiles'>['data']): (filepath: string) => boolean;
export declare function getSupportedFilePatterns(supportedFiles: SocketSdkSuccessResult<'getSupportedFiles'>['data']): string[];
...
export declare function isReportSupportedFile(filepath: string, supportedFiles: SocketSdkSuccessResult<'getSupportedFiles'>['data']): boolean;
