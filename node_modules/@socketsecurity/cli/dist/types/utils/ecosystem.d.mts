...
export declare const ALL_ECOSYSTEMS: readonly ["alpm", "apk", "bitbucket", "cargo", "chrome", "clawhub", "cocoapods", "composer", "conan", "conda", "cran", "deb", "docker", "gem", "generic", "github", "golang", "hackage", "hex", "huggingface", "maven", "mlflow", "npm", "nuget", "oci", "pub", "pypi", "qpkg", "rpm", "socket", "swift", "swid", "unknown", "vscode"];
