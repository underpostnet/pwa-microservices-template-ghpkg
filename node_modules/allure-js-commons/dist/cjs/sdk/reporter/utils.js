...
exports.md5 = md5;
var FALLBACK_TEST_CASE_ID_LABEL_NAME = exports.FALLBACK_TEST_CASE_ID_LABEL_NAME = "_fallbackTestCaseId";
var getFallbackTestCaseIdLabel = value => ({
  name: FALLBACK_TEST_CASE_ID_LABEL_NAME,
  value
});
exports.getFallbackTestCaseIdLabel = getFallbackTestCaseIdLabel;
...
var getWorstTestStepResult = steps => {
  ...
  var evaluableSteps = steps.filter(step => step.status !== undefined);
...
var getProjectRoot = exports.getProjectRoot = (() => {
  ...
  var resolveSearchDir = searchFrom => {
    var target = _nodePath.default.resolve(searchFrom !== null && searchFrom !== void 0 ? searchFrom : _nodeProcess.default.cwd());
    try {
      return _nodeFs.default.statSync(target).isFile() ? _nodePath.default.dirname(target) : target;
    } catch (_unused) {
      return target;
    }
  };
  var resolveProjectRootByPath = searchFrom => {
    ...
    while (true) {
      ...
      var parent = _nodePath.default.dirname(dir);
      if (parent === dir) {
...
var getProjectName = exports.getProjectName = (() => {
  ...
  return searchFrom => {
    ...
    var packageJsonPath = _nodePath.default.join(projectRoot, "package.json");
    var projectName;
    try {
      var packageJsonContent = _nodeFs.default.readFileSync(packageJsonPath, "utf-8");
...
var getRelativePath = (filepath, searchFrom) => {
