...
function _initStyledRootFromInnerOfThreeElements(env, inner, postApplyClasses, hasAncestorStyledRoot) {
...
var BaseEnvironment = class extends AgBeanStub {
  ...
  getStyledRootClasses(hasAncestorStyledRoot) {
    const { theme } = this;
  ...
  initStyledRoot() {
    this.addDestroyFunc(
      _initStyledRootFromInnerOfThreeElements(this, this.eRootDiv, void 0, this.beans.hasAncestorStyledRoot)
    );
  }
};
