...
export { type CoerceOptions, type Comparison, type ComparisonOperator, INCREMENT_TYPES, type IncrementOptions, type IncrementType, type PrereleaseIdentifier, SEMVER_SPEC_VERSION, type SemVer, TRUNCATION_TYPES, type TruncationType, type VersionDifference, type VersionInput, type VersionOptions, clean, coerce, compare, compareBuild, compareIdentifiers, compareIdentifiersReversed, compareMain, comparePrerelease, compareReversed, compareWithOperator, difference, getBuild, getMajor, getMinor, getPatch, getPrerelease, increment, isEqual, isGreater, isGreaterOrEqual, isLess, isLessOrEqual, isNotEqual, isPrerelease, isStable, isValid, normalize, normalizeFull, parse, sort, sortReversed, truncate, tryParse };