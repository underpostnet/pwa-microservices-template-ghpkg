...
export const getAsyncContext = () => {
    ...
    return (holder.__allureVitestAsyncContext ?? (holder.__allureVitestAsyncContext = {
        currentTaskStorage: new AsyncLocalStorage(),
        activeTasks: new WeakSet(),
    }));
};
...
//# sourceMappingURL=concurrentState.js.map