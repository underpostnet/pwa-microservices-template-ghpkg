...
export interface AgAxisContextMenuActionEvent<TContext = ContextDefault> extends AgChartEvent<'axisContextMenuAction', TContext> {
...
export interface AgCrossLineContextMenuActionEvent<TContext = ContextDefault> extends AgChartEvent<'crossLineContextMenuAction', TContext> {
