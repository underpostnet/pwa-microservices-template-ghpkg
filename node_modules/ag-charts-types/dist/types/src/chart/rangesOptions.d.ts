...
export type AgRangesButtonValue<TContext = ContextDefault> = number | AgRangesButtonValuePair | AgRangesButtonValueFunction<TContext> | AgTimeInterval | AgTimeIntervalUnit | undefined;
...
export type AgRangesButtonValueFunction<TContext = ContextDefault> = (params: AgRangesButtonValueFunctionParams<TContext>) => [Date | number | undefined, Date | number | undefined];
