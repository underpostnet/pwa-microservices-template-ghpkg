...
export interface AgMapMarkerSeriesLabel<TDatum, TContext = ContextDefault> extends AgChartLabelOptions<TDatum, AgMapMarkerSeriesLabelFormatterParams<TDatum>, TContext>, AgChartLabelCollisionFitOptions {
    /**
