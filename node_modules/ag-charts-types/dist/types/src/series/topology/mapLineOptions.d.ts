...
export type AgMapLineSeriesLabel<TDatum, TContext = ContextDefault> = AgChartLabelOptions<TDatum, AgMapLineSeriesLabelFormatterParams<TDatum>, TContext> & AgChartLabelCollisionFitOptions;
