...
export interface AgScatterSeriesLabel<TDatum, TContext = ContextDefault> extends AgChartLabelOptions<TDatum, AgScatterSeriesLabelFormatterParams<TDatum>, TContext>, AgChartLabelCollisionFitOptions, AgSeriesLabelPlacementStyleOptions {
    /**
