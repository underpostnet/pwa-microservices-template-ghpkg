...
export interface AgBubbleSeriesLabel<TDatum, TContext = ContextDefault> extends AgChartLabelOptions<TDatum, AgBubbleSeriesLabelFormatterParams<TDatum>, TContext>, AgChartLabelCollisionFitOptions, AgSeriesLabelPlacementStyleOptions {
    /**
